...
function ModalCreateProject({ closeModal, id_usuario }) {
    ...
    const enviarDatosProyecto = async (e) => {
        ...
        try {
            const token = localStorage.getItem('token'); // Obtener el token del localStorage (o desde donde lo almacenes)
        ...
        console.log("Datos de projecto que se envían:", projectData);
        console.log("id usuario que se envia:", id_usuario);
    };    
                        ...
                        <div className="create-project-form-step">
                            ...
                            <div className="create-project-form-group">
                                <label htmlFor="categoria">Categoría del Proyecto</label>
                                    <Select
                                        options={[
                                            {value: "desarrolloWeb", label: "Desarrollo Web"},
                                            {value: "disenoGrafico", label: "Diseño Gráfico"},
